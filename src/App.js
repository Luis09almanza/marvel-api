...
function App() {
  ...
  useEffect(()=>{
    ...
    axios.get('https://gateway.marvel.com:443/v1/public/characters?ts=1&apikey=84c9afc670217a09f2566ca3189177f9&hash=273ddb932eb9647e18e21c589d55f000').then(res=>{
        ...
        <div className='Characters_data'>
          { characters.map( per=>(
            ...
            <div className="Character__data">
                <h3 className="Character__name">{per.name}</h3>
            </div>
        </div>
